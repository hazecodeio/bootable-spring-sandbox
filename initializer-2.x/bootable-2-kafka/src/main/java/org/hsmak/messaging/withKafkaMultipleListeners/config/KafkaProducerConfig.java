...
public class KafkaProducerConfig {
    ...
    public KafkaTemplate<String, String> kafkaTemplate() {
        KafkaTemplate<String, String> kafkaTemplateOfString = new KafkaTemplate<>(producerFactory());
        return kafkaTemplateOfString;
    }
    ...
    // KafkaTemplate - Json User
    @Bean
    public KafkaTemplate<String, User> userKafkaTemplate() {
        KafkaTemplate<String, User> kafkaTemplateOfUser = new KafkaTemplate<>(userProducerFactory());
        return kafkaTemplateOfUser;
    }
}