package org.hsmak.kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() {
        ...
        consumerConfigProps.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        consumerConfigProps.put(ConsumerConfig.GROUP_ID_CONFIG, "group-id");
