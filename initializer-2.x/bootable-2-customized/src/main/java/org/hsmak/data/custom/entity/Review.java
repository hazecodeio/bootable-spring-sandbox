...
package org.hsmak.data.custom.entity;
...
import org.hsmak.data.custom.domain.TripType;
...
public class Review implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)//ToDo: AUTO mode failed inn Spring boot 2.x
	private Long id;
